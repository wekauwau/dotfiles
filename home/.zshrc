...
export HISTORY_IGNORE="(ls|cd|pwd|exit|sudo reboot|history|cd -|cd ..|touch|rustc|cargo new|git clone)"
...
alias mount-win="sudo mkdir -p /run/media/wekauwau/Windows\ 10 && sudo mount -t ntfs-3g /dev/sda4 /run/media/wekauwau/Windows\ 10"
alias umount-win="sudo umount /run/media/wekauwau/Windows\ 10"
alias music="ncmpcpp"
